...
public class AdminMain implements Initializable {
    @FXML private TextField adminnewpwedit;
    @FXML private TextField admincurrentpwedit;
    @FXML private TextField admineditage;
    @FXML private Button admineditbckbtn;
    @FXML private Button admineditbtn;
    @FXML private TextField admineditemail;
    @FXML private TextField admineditname;
    @FXML private Pane admineditpane;
    @FXML private Button adminhomepagebtn;
    @FXML private Pane adminhomepagepane;
    @FXML private Button adminlogoutbtn;
    @FXML private Button adminnewsmanagebtn;
    @FXML private Label adminpageage;
    @FXML private Label adminpageemail;
    @FXML private Label adminpagename;
    @FXML private Label adminpageuname;
    @FXML private Button adminprofilebckbtn;
    @FXML private Button adminprofilebtn;
    @FXML private Pane adminprofilepane;
    @FXML private Button adminsavebtn;
    @FXML private Button adminusermanegbtn;
    @FXML private TableColumn<User, String> agecolumn;
    @FXML private TableColumn<User, String> categoriescolumn;
    @FXML private TableColumn<User, String> emailcolumn;
    @FXML private TableColumn<User, String> fullnamecolumn;
    @FXML private Pane usermanagepane;
    @FXML private TableView<User> usermanagetable;
    @FXML private TableColumn<User, String> usernamecolumn;
    @FXML private Button userdeletebtn;
    @FXML private TextArea articlecontent;
    @FXML private TextField articletitle;
    @FXML private Pane newsmanagepane;
    @FXML private Button addarticlesbtn;
    @FXML private Pane addnewspane;
    @FXML private Button addnewsbackbtn;
    @FXML private Pane articledeletepane;
    @FXML private TableColumn<Document, String> contentdel;
    @FXML private TableColumn<Document, String> titledel;
    @FXML private TableView<Document> deletearticlestable;
    @FXML private Button deleteNewsarticlesbtn;
    @FXML private Button deletearticlesbtn;
    ...
    private void DeleteArticles() {
        ...
        DeleteResult result = database.getCollection("News_Articles").deleteOne(query);
